...
export default function PersonalDataHotels({
  ...
  return (
    <div className="text-gray-700 border border-gray-600 bg-primary-50 shadow-sm rounded-md py-3 px-2 flex flex-col w-full">
      ...
      <div className="mt-4 grid grid-cols-2 grid-rows-3 gap-x-4 gap-y-6">
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            className="py-2 pl-2 disabled:bg-gray-400 disabled:text-gray-200 border border-black bg-primary-50 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent w-[330px] "
            style={{
              transition:
