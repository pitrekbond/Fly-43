...
export default function PriceHotel({
  ...
  return (
    <div className="text-gray-700 border-1 border-gray-600 bg-primary-50 shadow-sm rounded-md py-3 flex flex-col items-start max-sm:w-[90%] max-lg:w-[80%] lg:w-[320px]">
